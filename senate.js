let longitud = data.results[0].members.length
  ...
  { 
    ...
    if (middleName == null && votes == null) {      
      document.getElementById("senateTable").innerHTML+= "<tr><td>"+nuMembers+"</td><td>"+firstName+"</td><td>"+"-----"+"</td><td>"
    ...
    +lastName+"</td><td>"+party+"</td><td>"+votes+"</td></tr>";      
      ...
      document.getElementById("senateTable").innerHTML+= "<tr><td>"+nuMembers+"</td><td>"+firstName+"</td><td>"+middleName+"</td><td>"
    +lastName+"</td><td>"+party+"</td><td>"+"-----"+"</td></tr>";
     } else{ 
